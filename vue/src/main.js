...
import Vuetify, {
    ...
    VToolbarTitle, VCardText, VFooter, VCard, VCardSubtitle, VCardTitle, VImg, VForm, VCardActions, VTextarea, VListItemGroup, VSubheader
} from 'vuetify/lib';
...
Vue.use(Vuetify, {
    components: {
        ...
        VCardText, VFooter, VCard, VToolbarTitle, VCardSubtitle, VCardTitle, VImg, VForm, VCardActions, VTextarea, VListItemGroup, VSubheader
    },
});
